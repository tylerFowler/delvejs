...
function getBreakpoints() {
  return this.rpcClient.callAsync('ListBreakpoints', null)
...
function getBreakpointById(id) {
  return this.rpcClient.callAsync('GetBreakpoint', id)
...
function getBreakpointByName(name) {
  return this.rpcClient.callAsync('GetBreakpointByName', name)
  .then(bp => new types.Breakpoint(bp))
  .catch(() => null);
};
...
function findLocationsForArgs(locationArgs, _scope) {
  ...
  return this.rpcClient.callAsync('FindLocation', {Scope, Loc: locationArgs})
  .catch(
...
function clearBreakpointById(id) {
  return this.rpcClient.callAsync('ClearBreakpoint', id)
  .catch(RPCError.ServerError, wrapServerErr);
};

Delve.prototype.clearBreakpointByName =
function clearBreakpointByName(name) {
  return this.rpcClient.callAsync('ClearBreakpointByName', name)
  .catch(RPCError.ServerError, wrapServerErr);
};

Delve.prototype.getThreads =
function getThreads() {
  return this.rpcClient.callAsync('ListThreads');
};
...
function getThread(id) {
  return this.rpcClient.callAsync('GetThread', id)
...
function getPackageVars(filter, threadId) {
  ...
  if (threadId) {
    ...
    p = this.rpcClient.callAsync('ListThreadPackageVars', threadArgs);
  } else p = this.rpcClient.callAsync('ListPackageVars', filter);
...
function getRegisters() {
  return this.rpcClient.callAsync('ListRegisters')
  .catch(RPCError.ServerError, wrapServerErr);
};

Delve.prototype.listLocalVars =
function listLocalVars(goroutineId, frame) {
  return this.rcpClient.callAsync(
    'ListLocalVars', types.Scope.makeScope(goroutineId, frame)
  )
  .catch(RPCError.ServerError, wrapServerErr);
};
